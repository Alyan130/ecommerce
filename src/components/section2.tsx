        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            <div className="lg:row-span-2">
              <div  data-aos="fade-right" className="relative aspect-[4/3] lg:aspect-auto overflow-hidden bg-[#F5F5F5] rounded-sm h-full">
                <img
            ...
            <div  data-aos="fade-up" className="grid grid-cols-2 gap-4 h-full">
